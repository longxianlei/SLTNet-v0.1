...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default="/home/zhuxiaxin/share_container/Datasets/zhuxx/ddd17_seg", help="/home/zhuxx/datasets/ddd17_seg or /home/zhuxx/datasets/DSEC_Semantic")
...
def train_model(args):
    ...
    if args.lr_schedule == 'poly':
        ...
        scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=5, gamma=0.92, last_epoch=-1, verbose='deprecated')
